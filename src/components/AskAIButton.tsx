...
import { askAIAboutNotesAction } from '@rt/actions/notes';
import '@rt/styles/ai-response.css';
...
function AskAIButton({ user }: Props) {
  ...
  return (
    <Dialog open={open} onOpenChange={handleOnOpenChange}>
      ...
      <DialogContent
        className="custom-scrollbar flex h-[85vh] max-w-4xl min-w-3xl flex-col overflow-y-auto"
        ref={contentRef}
      >
        <DialogHeader>
